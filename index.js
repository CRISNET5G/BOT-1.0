...
senhavps = "Cs5725bel@"
apipremium = "crisnet"
linkapp = "https://www.mediafire.com/file/eydap80oafz4v54/CRISNET_5G%252B.apk/file"
...
valor1 = "R$ 15"
linkpag ="https://my.gestorvip.com/p/OTcxNA"
...
valor2 = "R$ 25"
linkpag2 ="https://my.gestorvip.com/p/OTcxNQ"
...
valor3 = "R$ 35"
linkpag3 ="https://my.gestorvip.com/p/OTcxNg"
delivery3 ="equipevip3"




// Dúvidas contate 92984762658 \\
...
const { state, saveState } = await useSingleFileAuthState('./MASTER-QR.json')
...
var nomor = info.participant
sug = `*NOTIFICAÇÃO IMPORTANTE*\n\n*De:* wa.me/${sender.split("@s.whatsapp.net")[0]}\n\n Alguém Precisa de suporte no pv do Bot de vendas e estou aqui para notifica-lo`
await conn.sendMessage(`559284762658@s.whatsapp.net`, {text: sug}, {quoted: info})
reply(`Notificação enviada ao meu dono em breve ele irá entrar em contato, Obrigado pela preferencia caso deseje falar com ele diretamente clique aqui\n\n wa.me/559284762658\n\n`)
break
...
case 'menuadm':
botaoale = [
{title: "SEJA BEM-VINDO AO MENU ADM",
rows: [
